       ...
       <div className="h-10 border- ">
        <img src={ala} alt="" className="blur-[3px] absolute w-full h-200" />
            ...
            <div className=" absolute flex mt-30">
                ...
                <div className=''>
                   <h1 className="text-[120px] ml-37 mt-20 text-[#E37345] leading-30 justify-self-center    w-280 text-center font-bold">  DCU <span className="text-[120px] w-130 font-bold text-[#F0F0F0]  ">rock climbing</span> club</h1>
